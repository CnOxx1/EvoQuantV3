...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="市场状态识别模块运行入口")
    parser.add_argument(
        "--mode", choices=["detect", "history"], default="detect",
        help="detect: 执行状态识别；history: 查看状态历史",
    )
