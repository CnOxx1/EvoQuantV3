...
test-paper: ## 论文服务相关单元测试（含 JF 识别不变量与 LLM consumer）
	$(PYTHON) -m pytest tests/test_paper_lab.py tests/test_jf_inference.py tests/test_jf_identification.py tests/test_jf_extras.py tests/test_paper_e2e.py tests/test_raw_pit_and_reconcile.py tests/test_llm_consumer.py tests/ai_market_context tests/time_slice -q
