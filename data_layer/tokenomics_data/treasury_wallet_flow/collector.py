...
class TreasuryWalletFlowCollector(TokenomicsCollectorBase):
    """基金会/国库钱包流向采集器。"""

    FIELD_FACTOR_MAP = {
        "treasury_wallet_inflow": "treasury_wallet_inflow",
        "treasury_wallet_outflow": "treasury_wallet_outflow",
        "foundation_wallet_netflow": "foundation_wallet_netflow",
    }
    ...
    def fetch_recent_points(
        ...
        source = load_tokenomics_sources(
            source_names=["treasury_wallet_flow"],
            enabled_only=False,
        )[0]
        factors = {
